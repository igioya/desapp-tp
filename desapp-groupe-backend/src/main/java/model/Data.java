...
public class Data {
	...
	User user1 = new User("20250010028", "Jose", "Lopez", "Saenz Peña 45, Bernal", "jlopez@gmail.com");
	User user2 = new User("20300010025", "Pablo" , "Perez", "Andrade 500, Bernal", "pp@gmail.com");
	...
	Publication publictionCar1 = new Publication(car1, null, null,
			car1.getDescription(), "01142241818", 25d, user1);
	Publication publictionCar2 = new Publication(car2, null, null,
			car2.getDescription(), "01142249999", 50d, user2);
	Publication publictionTruck1 = new Publication(truck1, null, null,
			truck1.getDescription(), "01142249999", 75d, user2);
	Publication publictionMotorbike1 = new Publication(motorbike1, null, null,
			motorbike1.getDescription(), "01142241818", 5d, user1);
